...
<head>
    ...
    <title>✈️ Lista de Aviones</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-activo { background: #4caf50; color: white; padding: 3px 10px; border-radius: 15px; font-size: 12px; }
        .status-mantenimiento { background: #ff9800; color: white; padding: 3px 10px; border-radius: 15px; font-size: 12px; }
        .status-retirado { background: #f44336; color: white; padding: 3px 10px; border-radius: 15px; font-size: 12px; }
...
<body>
    <div class="container">
        ...
        <div class="navbar">
            ...
            <a href="aviones_list.php" style="background:rgba(255,255,255,0.3);">📋 Consultar</a>
            <a href="aviones_create.php">➕ Crear</a>
            <a href="aviones_update.php">✏️ Modificar</a>
            <a href="aviones_delete.php">🗑️ Eliminar</a>
        ...
        <?php endif; ?>
        <a href="aviones_create.php" class="btn-agregar">➕ Crear Nuevo Avión</a>
        <table>
            <thead><tr><th>ID</th><th>Matrícula</th><th>Modelo</th><th>Fabricante</th><th>Capacidad</th><th>Año</th><th>Estado</th><th>Acciones</th></tr></thead>
            <tbody>
                <?php if (count($aviones) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="8" style="text-align:center;padding:30px;">🚫 No hay aviones registrados</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
