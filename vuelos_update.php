...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($numero_vuelo) || empty($origen) || empty($destino)) {
        ...
        $resultado = $crud->updateVuelo($id, $numero_vuelo, $avion_id, $origen, $destino, $hora_salida, $hora_llegada, $estado);
        if ($resultado) {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { color: #1a3a5c; border-bottom: 3px solid #ff9800; padding-bottom: 10px; margin-bottom: 20px; }
        ...
        .btn-actualizar { background: #ff9800; color: white; padding: 12px 30px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; }
        .btn-actualizar:hover { background: #e68900; }
        ...
        .info-vuelo { background: #e3f2fd; padding: 10px; border-radius: 5px; margin-bottom: 20px; }
    </style>
</head>
<body>
    <div class="container">
